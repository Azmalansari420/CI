...
<head>
	<!-- Required meta tags -->
	<title>Site Setting Update</title>
												...
												<div class="card">
													<div class="card-body">
														...
														<div class="row mb-3">
															...
															<div class="col-sm-9">
																<textarea name="map" class="form-control"><?php echo $EDITDATA[0]->map; ?></textarea>
															</div>
														</div>
														...
														<div class="row mb-3">
															...
															<div class="col-sm-9">
																<input type="text" class="form-control" name="linkdin" value="<?php echo $EDITDATA[0]->linkdin; ?>">
															</div>
														</div>
														...
														<div class="row mb-3">
															...
															<div class="col-sm-9">
																<input type="text" class="form-control" name="google" value="<?php echo $EDITDATA[0]->google; ?>">
															</div>
														</div>
